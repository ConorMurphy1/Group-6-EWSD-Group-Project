        ...
        <div class="flex space-x-5 mb-2">
            ...
            <div>
                <button id="like-{{ $idea->id }}" type="button" class="focus:outline-none">
                    <div id="like-icon-outline-{{ $idea->id }}">
                    ...
                    <div id="like-icon-solid-{{ $idea->id }}">
            ...
            <script>
                var userLiked = {{ $idea->reactions()->where('user_id', auth()->id())->where('reaction', 'like')->exists() ? 'true' : 'false' }};

                if(!userLiked) {
                    document.querySelector('#like-icon-outline-{{ $idea->id }}').classList.toggle('hidden');
                } else {
                    document.querySelector('#like-icon-solid-{{ $idea->id }}').classList.toggle('hidden');
                }
                ...
                document.getElementById('like-{{ $idea->id }}').addEventListener('click', function() {
                    ...
                    .then(function(data) {
                        ...
                        document.querySelector('#like-icon-outline-{{ $idea->id }}').classList.toggle('hidden');
                        document.querySelector('#like-icon-solid-{{ $idea->id }}').classList.toggle('hidden');
                        document.querySelector('#unlike-icon-outline-{{ $idea->id }}').classList.toggle('hidden');
                        document.querySelector('#unlike-icon-solid-{{ $idea->id }}').classList.toggle('hidden');
                    })
            ...
            <div>
                <button id="unlike-{{ $idea->id }}" type="button" class="focus:outline-none">
                    <div id="unlike-icon-outline-{{ $idea->id }}">
                    ...
                    <div id="unlike-icon-solid-{{ $idea->id }}">
            ...
            <script>
                var userUnliked = {{ $idea->reactions()->where('user_id', auth()->id())->where('reaction', 'unlike')->exists() ? 'true' : 'false' }};
